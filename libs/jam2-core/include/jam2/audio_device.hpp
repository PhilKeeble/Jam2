...
inline constexpr std::int32_t kTrackTakeIncludePrepared = 1 << 8;
inline constexpr std::int32_t kTrackTakeIncludeMetronome = 1 << 9;
...
struct StreamControl {
    ...
    std::atomic<std::int32_t> track_take_options{0};
...
struct StreamInfo {
    ...
    long buffer_size = 0;
    long maximum_callback_frames = 0;
    bool variable_callback_frames = false;
    long input_latency_frames = 0;
    long output_latency_frames = 0;
    long input_device_latency_frames = 0;
    long input_safety_offset_frames = 0;
    long input_stream_latency_frames = 0;
    long output_device_latency_frames = 0;
    long output_safety_offset_frames = 0;
    long output_stream_latency_frames = 0;
    std::size_t input_stream_count = 0;
    std::size_t output_stream_count = 0;
    bool processor_overload_listener_active = false;
    long processor_overload_listener_error = 0;
    bool abnormal_stop_listener_active = false;
    long abnormal_stop_listener_error = 0;
...
struct CallbackTimingStats {
    ...
    std::uint64_t frame_min = 0;
    std::uint64_t frame_max = 0;
    std::uint64_t frame_samples = 0;
    std::uint64_t frame_capacity_exceeded = 0;
    std::uint64_t processor_overloads = 0;
    std::uint64_t abnormal_stops = 0;
    std::uint64_t timestamp_callbacks = 0;
    std::uint64_t timestamp_invalid_callbacks = 0;
    std::uint64_t cycle_to_callback_min_ns = 0;
    std::uint64_t cycle_to_callback_sum_ns = 0;
    std::uint64_t cycle_to_callback_max_ns = 0;
    std::uint64_t cycle_to_callback_samples = 0;
    std::uint64_t input_to_cycle_min_ns = 0;
    std::uint64_t input_to_cycle_sum_ns = 0;
    std::uint64_t input_to_cycle_max_ns = 0;
    std::uint64_t input_to_cycle_samples = 0;
    std::uint64_t cycle_to_output_min_ns = 0;
    std::uint64_t cycle_to_output_sum_ns = 0;
    std::uint64_t cycle_to_output_max_ns = 0;
    std::uint64_t cycle_to_output_samples = 0;
    std::uint64_t cycle_jitter_min_ns = 0;
    std::uint64_t cycle_jitter_sum_ns = 0;
    std::uint64_t cycle_jitter_max_ns = 0;
    std::uint64_t cycle_jitter_samples = 0;
};
