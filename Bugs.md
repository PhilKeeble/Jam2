...
allow export to midi option for chord and beat view?

daw functionality on the track view for splitting tracks and doing multiple takes on a track and splicing them together in a useful workflow?? 
