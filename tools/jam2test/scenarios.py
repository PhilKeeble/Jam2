...
def scenario_catalog(base_profile=FAST_PROFILE):
    return {
        ...
        "grid-stop-restart-shared-grid": {
            ...
            "impairment": ProxyImpairment.both(DirectionImpairment(jitter_ms=20.0)),
            "commands": [
                {"at_s": 2.0, "side": "server", "line": "metro off"},
                {"at_s": 4.0, "side": "server", "line": "metro on"},
        ...
        "grid-noop-running-controls": {
            ...
            "commands": [
                ...
                {"at_s": 5.0, "side": "client", "line": "bpm 120"},
                {"at_s": 6.0, "side": "client", "line": "metro mode shared-grid"},
                {"at_s": 7.0, "side": "server", "line": "metro on"},
                {"at_s": 8.0, "side": "server", "line": "bpm 120"},
                {"at_s": 9.0, "side": "server", "line": "metro mode shared-grid"},
            ],
            "expect": "duplicate running, BPM, and mode controls must not order a new grid revision or replace the current authority epoch",
        },
        ...
        "transport-track-actions": {
            ...
            "prepared_track": True,
            "commands": [
                {"at_s": 2.0, "side": "server", "line": "track play now"},
                {"at_s": 7.0, "side": "server", "line": "track stop now"},
                {"at_s": 12.0, "side": "server", "line": "track restart"},
            ],
            "expect": "play, stop, and restart should remain distinct source-identified transport actions with one ordered event counter on both peers",
        },
        "transport-track-actions-joiner": {
            "profile": base_profile,
            "impairment": ProxyImpairment.both(DirectionImpairment(jitter_ms=20.0)),
            "prepared_track": True,
            "commands": [
                {"at_s": 4.0, "side": "client", "line": "track play now"},
                {"at_s": 9.0, "side": "client", "line": "track stop now"},
                {"at_s": 14.0, "side": "client", "line": "track restart"},
            ],
            "expect": "a joiner should initiate the same synchronized source-identified play, stop, and restart sequence as the creator",
        },
        "transport-record-start-joiner": {
            "profile": base_profile,
            "impairment": ProxyImpairment.both(DirectionImpairment(jitter_ms=20.0)),
            "prepared_track": True,
            "commands": [
                {"at_s": 3.0, "side": "client", "line": "track record-start 1"},
            ],
            "expect": "a joiner RecordStart should cross the Track Sync path and restart both prepared tracks on one future take boundary",
        },
        "transport-track-sync-off": {
            ...
            "prepared_track": True,
            "commands": [
                {"at_s": 2.0, "side": "client", "line": "track sync off"},
                {"at_s": 4.0, "side": "client", "line": "track play now"},
                {"at_s": 7.0, "side": "client", "line": "track stop now"},
                {"at_s": 10.0, "side": "server", "line": "track play now"},
                {"at_s": 15.0, "side": "server", "line": "track stop now"},
            ],
            "expect": "a sync-disabled peer should keep local track controls private and ignore authenticated peer track actions",
        },
