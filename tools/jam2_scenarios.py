    ...
    return {
        ...
        "last-peer-departure-grid-restart": {
            ...
            "commands": [
                ...
                {"at_s": 6.0, "side": "server", "line": "metro on"},
            ],
            "expected_early_client_exit": True,
            "expect": "after the only remote authority leaves, the creator should retain the session, clear stale scheduling, and start a fresh local grid revision",
        },
